...
from sqlalchemy import Boolean, Column, Integer, String, DateTime, BigInteger #importamos las clases necesarias para crear la tabla
...
class Users(Base):
    ...
    phone = Column(BigInteger, nullable=False) #phone es un entero y no puede ser nulo
